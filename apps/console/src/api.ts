...
// NOTE: the internal admin surface (model routing, provider keys, customers — the
// `/admin/*` endpoints and their types) is NOT part of the customer console. It lives
// in the separate admin app (apps/admin) so nothing internal ships in this bundle. See
// Phase 9 in apps/README.md.
